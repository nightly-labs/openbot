...
Open **Server settings → Import** on this computer. Add the [OpenBot export agent](https://x.ai/bot/SeMqhg9bPD4Qd_8i7I-vN) to Grok Bot and say "Export my agents for OpenBot". It saves one `.zip` file to Downloads. Choose that file in OpenBot, select the agents, and import them.
