...
3. Keep the style that the description asks for. If it gives no style, ask for a detailed, realistic portrait. Frame one centered subject, head and shoulders, so it reads in a small circle. Do not add text, a logo, or a watermark.
