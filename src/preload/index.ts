...
const openbotApi: OpenBotDesktopApi = {
  ...
  agent: {
    ...
    listGroups: () => invokeAgent(IPC_CHANNELS.agentListGroups, null, decodeGroupSummaries),
    readGroup: (input) => invokeAgent(IPC_CHANNELS.agentReadGroup, input, decodeGroupPage),
    groupCommand: (input) => invokeAgent(IPC_CHANNELS.agentGroupCommand, input, decodeGroup),
