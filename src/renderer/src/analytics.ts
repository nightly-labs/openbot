import { FAILURE_CODES } from "@openbot/contracts/analytics-failures";
import {
  AGENT_PROVIDERS,
...
// One shared list with the host process. The two used to drift: a code the
// renderer knew was dropped by the host as "unknown", and the reverse.
const SAFE_FAILURE_CODES: ReadonlySet<string> = new Set<string>(FAILURE_CODES);
