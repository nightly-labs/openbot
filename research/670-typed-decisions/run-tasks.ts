...
// Usage: bun research/670-typed-decisions/run-tasks.ts --driver=jev|muse-minimal|muse-low [--tasks=login,filters]
// The jev driver needs TYPESAFE_API_KEY and OPENCODE_API_KEY (text helper); the muse drivers need OPENCODE_API_KEY.
