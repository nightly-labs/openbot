...
// `src/main/remote-*-decoding.ts` family decodes what a remote team server sends this machine. They
// had a hand-written copy each of the same five readers, with identical logic and identical
// messages, and each was the kind of function whose second copy drifts silently.
//
