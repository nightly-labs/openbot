export const IPC_CHANNELS = {
  ...
  agentListWatchers: "agent:list-watchers",
  agentCreateWatcher: "agent:create-watcher",
  agentUpdateWatcher: "agent:update-watcher",
  agentDeleteWatcher: "agent:delete-watcher",
  agentTestWatcher: "agent:test-watcher",
  agentListWatcherMatches: "agent:list-watcher-matches",
