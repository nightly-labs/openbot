...
export type OpencodeRuntimeTarget = "darwin-arm64" | "linux-x64" | "linux-arm64" | "win32-x64";
...
const TARGET_IDS: readonly OpencodeRuntimeTarget[] = ["darwin-arm64", "linux-x64", "linux-arm64", "win32-x64"];
