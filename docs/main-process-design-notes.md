...
An MCP server that asks its users to sign in sends the grant back to a redirect address. OpenBot
...
page, where OpenBot can see nothing and can explain nothing. Canva does this: it accepts
